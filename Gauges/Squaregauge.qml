    ...
    */
    ...
    Item {
        ...
        Menu {
            ...
            MenuItem {
                text: qsTr("Toggle vertical bar gauge")
                font.pixelSize: 15
                onClicked: {
            ...
            MenuItem {
                text: qsTr("Toggle horizontal bar gauge")
                font.pixelSize: 15
                onClicked: {
