            ...
            function change() {
                ...
                if (trackselect.textAt(
                    ...
                    map.center = QtPositioning.coordinate(
                                ...
                                17)map.zoomLevel = 15.6map.bearing = 43map.tilt = 0
                }
                ;
                if (trackselect.textAt(
                    ...
                    map.center = QtPositioning.coordinate(
                                -26.074283,
                                28.751711)map.zoomLevel = 16map.bearing
                            = 0map.tilt = 0GPS.defineFinishLine(-26.075097,
                                                                28.755060,
                                                                -26.075111,
                                                                28.755229)
                }
                ...
                if (trackselect.textAt(
                    ...
                    map.center = QtPositioning.coordinate(
                                ...
                                398)map.zoomLevel = 15.1map.bearing = 90map.tilt = 0
                }
                ;
                if (trackselect.textAt(
                    ...
                    map.center = QtPositioning.coordinate(
                                -34.840764,
                                149.686800)map.zoomLevel = 16map.tilt
                            = 0map.bearing = 0GPS.defineFinishLine(-34.840111,
                                                                   149.685229,
                                                                   -34.840172,
                                                                   149.685433)
                }
                ...
                if (trackselect.textAt(
                    ...
                    map.center = QtPositioning.coordinate(
                                50.358917,
                                6.965215)map.zoomLevel = 16map.bearing = 0map.tilt = 0
                }
                ;
                if (trackselect.textAt(
                ...
                if (trackselect.textAt(
                    ...
                    map.center = QtPositioning.coordinate(
                                -28.685079,
                                151.938694)map.zoomLevel = 17map.tilt = 0map.bearing = 22
                }
                if (trackselect.textAt(
                            trackselect.currentIndex) === "Phakisa") {
                    map.center = QtPositioning.coordinate(
                                -27.904231,
                                26.713996)map.zoomLevel = 15.6map.tilt = 0map.bearing = 22
                }
                if (trackselect.textAt(
                            trackselect.currentIndex) === "Midvaal") {
                    map.center = QtPositioning.coordinate(
                                -26.612376, 28.059484)map.zoomLevel = 16map.tilt
                            = 0map.bearing = 22GPS.defineFinishLine(-26.613392,
                                                                    28.058586,
                                                                    -26.613509,
                                                                    28.058717)
                }
                if (trackselect.textAt(trackselect.currentIndex) === "Dezzi") {
                    map.center = QtPositioning.coordinate(
                                -30.770474,
                                30.426004)map.zoomLevel = 16map.tilt = 0map.bearing = 22
                }
            }
        }
