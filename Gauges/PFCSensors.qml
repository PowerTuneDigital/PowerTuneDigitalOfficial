...
Rectangle {
    ...
    color:"transparent"
    property int sizeoftext : sensorwindow.width * (20 / sensorwindow.width)//sensorwindow.width /32
    ...
    Row {
        ...
        width: parent.width
        height: parent.height
        //Calculate the total pixels of the parent item and divide it by (20/1280) which is 6 pixel spacing / total screen pixels of 7"
        ...
        Grid {
            ...
            //ROW 1
            Text {
                font.pixelSize: sensorwindow.width * 0.050
                color:"white"
            ...
            StatusIndicator {
                height: sensorwindow.width * 0.050
                width: height
                color: "green"
