...
//                    if (backroundpicture3.source == PTBaseUrl + "/Logo/" + backroundSelector.textAt(i))
        ...
        Grid{
            ...
            ComboBox {
                ...
                onCurrentIndexChanged: {
                    ...
                    backroundpicturesource3 = PTBaseUrl + "/Logo/" + backroundSelector.textAt(backroundSelector.currentIndex);
